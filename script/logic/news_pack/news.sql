...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM ADD_NEWS FOR SYSTEM.ADD_NEWS;
...
END ADD_NEWS;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM DELETE_NEWS_BY_ID FOR SYSTEM.DELETE_NEWS_BY_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM DELETE_NEWS_BY_TITLE FOR SYSTEM.DELETE_NEWS_BY_TITLE;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM UPDATE_NEWS FOR SYSTEM.UPDATE_NEWS;
...
END UPDATE_NEWS;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_NEWS FOR SYSTEM.GET_NEWS;
...
END GET_NEWS;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_NEWS_BY_ID FOR SYSTEM.GET_NEWS_BY_ID;
...
END GET_NEWS_BY_ID;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_NEWS_BY_TITLE FOR SYSTEM.GET_NEWS_BY_TITLE;
