...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM REGISTRATION FOR SYSTEM.REGISTRATION;
...
END REGISTRATION;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM CHANGE_AGE FOR SYSTEM.CHANGE_AGE;
...
END CHANGE_AGE;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM CHANGE_INFO FOR SYSTEM.CHANGE_INFO;
...
END CHANGE_INFO;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM CHANGE_AVATAR FOR SYSTEM.CHANGE_AVATAR;
...
END CHANGE_AVATAR;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM LOGIN FOR SYSTEM.LOGIN;
...
END LOGIN;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_USER_BY_ID FOR SYSTEM.GET_USER_BY_ID;
...
END GET_USER_BY_ID;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_USERS_BY_NAME FOR SYSTEM.GET_USERS_BY_NAME;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_USER_BY_EMAIL FOR SYSTEM.GET_USER_BY_EMAIL;
