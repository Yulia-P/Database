...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM ADD_PHOTO FOR SYSTEM.ADD_PHOTO;
...
END ADD_PHOTO;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM DELETE_PHOTO_BY_ID FOR SYSTEM.DELETE_PHOTO_BY_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM DELETE_PHOTO_BY_ALBUM_ID FOR SYSTEM.DELETE_PHOTO_BY_ALBUM_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM UPDATE_PHOTO_COORDS FOR SYSTEM.UPDATE_PHOTO_COORDS;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_PHOTOS_BY_ALBUM_ID FOR SYSTEM.GET_PHOTOS_BY_ALBUM_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_PHOTO_BY_ID FOR SYSTEM.GET_PHOTO_BY_ID;
...
END GET_PHOTO_BY_ID;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_PHOTO_BY_USER_ID FOR SYSTEM.GET_PHOTO_BY_USER_ID;
