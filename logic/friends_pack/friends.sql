...
--------------------------------------------------------------------------------
CREATE OR REPLACE PUBLIC SYNONYM ADD_FRIEND FOR SYSTEM.ADD_FRIEND;
...
END ADD_FRIEND;
--------------------------------------------------------------------------------
CREATE OR REPLACE PUBLIC SYNONYM DELETE_FRIEND_BY_ID FOR SYSTEM.DELETE_FRIEND_BY_ID;
...
--------------------------------------------------------------------------------
CREATE OR REPLACE PUBLIC SYNONYM GET_FRIEND_BY_ID FOR SYSTEM.GET_FRIEND_BY_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_FRIENDS_BY_NAME FOR SYSTEM.GET_FRIENDS_BY_NAME;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_FRIEND_BY_EMAIL FOR SYSTEM.GET_FRIEND_BY_EMAIL;
