...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM ADD_MESSAGE FOR SYSTEM.ADD_MESSAGE;
...
END ADD_MESSAGE;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM CHECK_MESSAGE_SENDER FOR SYSTEM.CHECK_MESSAGE_SENDER;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM DELETE_MESSAGE FOR SYSTEM.DELETE_MESSAGE;
...
END DELETE_MESSAGE;
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_MESSAGE_BY_ID FOR SYSTEM.GET_MESSAGE_BY_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_MESSAGES_BY_DIALOG_ID FOR SYSTEM.GET_MESSAGES_BY_DIALOG_ID;
...
--------------------------------------------------------------------------------
CREATE PUBLIC SYNONYM GET_MESSAGES_BY_SENDER_ID FOR SYSTEM.GET_MESSAGES_BY_SENDER_ID;
